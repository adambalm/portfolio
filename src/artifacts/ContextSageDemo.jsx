...
export default function ContextSageDemo() {
  ...
  const renderArchitecture = () => (
    <section data-section="architecture">
      {/* Visual Overview - Gemini-generated explainer */}
      <figure style={{ margin: '0 0 2em 0' }}>
        <img
          src={`${import.meta.env.BASE_URL}images/context-sage.jpg`}
          alt="Four-panel architecture diagram: Panel 1 shows the Transmission metaphor with human driver providing intent through Context Sage (institutional memory) and Skill Forge (steering) to the AI engine producing governed output. Panel 2 shows the Brake and Clutch workflow where human input triggers a specification gate before AI execution. Panel 3 illustrates skill creation where patterns are extracted to a vector store, enabling amortization over time. Panel 4 shows the full wiring diagram with Human Orchestrator, Understanding Gate, Agreement Gate, Execution Authorization, Generalizing AI, Inspecting AI, Basic Memory, and GitHub repo output."
          style={{
            width: '100%',
            maxWidth: '800px',
            height: 'auto',
        ...
        <figcaption style={{
          ...
          Visual overview generated by Gemini after inspecting repository code
        </figcaption>
      </figure>
